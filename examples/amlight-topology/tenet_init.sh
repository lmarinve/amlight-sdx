...
curl -H 'Content-Type: application/json' -X POST $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:11:42/enable
...
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth20"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:11:20/metadata
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth61"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:11:61/metadata
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth99"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:11:99/metadata
...
curl -H 'Content-Type: application/json' -X POST $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:22:43/enable
curl -H 'Content-Type: application/json' -X POST $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:22:62/enable
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth20"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:22:20/metadata
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth62"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:22:62/metadata
...
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth63"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:33:63/metadata
curl -H 'Content-Type: application/json' -X POST -d'{"mtu": 9000, "port_name": "eth99"}' $TOPOLOGY_API/interfaces/cc:00:00:00:00:00:00:33:99/metadata
